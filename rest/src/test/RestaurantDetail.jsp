...
<tr>
  <th>사진</th>
  <td>
  <img width="200" height="200" src='../file/${(empty restaurant.photo)?"default.png":restaurant.photo}'><br>
  </td>
</tr>
<tr>
  <th>별점</th>
  <td>
<c:forEach begin="1" end="${restaurant.calcstar}"> 
  <img src="../file/star.png">
</c:forEach>
<form action="plusStar.do" method="POST">
 ${restaurant.countstar} 명 <br>
